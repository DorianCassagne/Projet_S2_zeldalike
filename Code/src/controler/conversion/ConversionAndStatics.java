...
/*
 * Cette classe contient les mÃ©thodes statiques utilises par le controleur, cette classe peut servir a  : 
...
public class ConversionAndStatics {
	 ...
	 * @param TilePane tile : c'est le tilePane Ã  qui on dÃ©finira le nombre de case
